package br.com.ilikeweb.emerson.fcm
...
import br.com.ilikeweb.emerson.ultils.NotificationManagerUtils
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        super.onMessageReceived(remoteMessage) //metodo de entrada da notificação
        //remoteMessage.data
